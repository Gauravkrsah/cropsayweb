...
brandrouter.post("/createbrand",loginCheck, hasPermission("admin"), uploadfile().none(), bodyValidator(BrandDTO), BrandCtrl.CreateBrand )
brandrouter.patch("/updatebrand/:id",loginCheck, hasPermission("admin"), uploadfile().none(), bodyValidator(BrandDTO), BrandCtrl.UpdateBrand )
