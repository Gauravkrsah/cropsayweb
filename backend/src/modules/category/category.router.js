...
categoryrouter.post("/createcategory",loginCheck, hasPermission("admin"), upload.none(), bodyValidator(CategoryDTO), CategoryCtrl.CreateCategory )
categoryrouter.patch("/updatecategory/:id",loginCheck, hasPermission("admin"), upload.none(), bodyValidator(CategoryDTO), CategoryCtrl.UpdateCategory )
